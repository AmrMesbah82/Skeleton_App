...
class _CustomTableWidgetState extends State<CustomTableWidget> {
  ...
  void initState() {
    ...
    for (var rowData in widget.initialData) {
      tableData.add({
        widget.columnName1.tr: rowData.isNotEmpty ? rowData[0] : '',
        widget.columnName2.tr: rowData.length > 1 ? rowData[1] : '',
        widget.columnName3.tr: rowData.length > 2 ? rowData[2] : '',
      });
    }
  }
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  widget.columnName1.tr,
                  style: customTextStyle,
                ),
                Text(
                  widget.columnName2.tr,
                  style: customTextStyle,
                ),
                Text(
                  widget.columnName3.tr,
                  style: customTextStyle,
                ),
              ],
            ),
                        ...
                        child: Row(
                          children: [
                            SizedBox(
                              ...
                              child: Flexible(
                                child: Text(
                                  tableData[index][widget.columnName1.tr]!
                            ...
                            SizedBox(
                              ...
                              child: Flexible(
                                child: Text(
                                  tableData[index][widget.columnName2.tr]!
                                          .capitalize as String,
                                  style: customDataTextStyle,
                                ),
                              ),
                            ...
                            SizedBox(
                              ...
                              child: Flexible(
                                child: Text(
                                  tableData[index][widget.columnName3.tr]!
                                          .capitalize as String,
                                  style: customDataTextStyle,
                                ),
                              ),
