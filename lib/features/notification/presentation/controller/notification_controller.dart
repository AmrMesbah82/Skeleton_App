...
import 'package:demo_app/features/notification/data/models/notification_model_core.dart';

class MainCoreNotificationController extends GetxController {
        ...
        await dio
          ...
          (value) async {
            /*NotificationModel notification = NotificationModel(
              titleEnglish: title.toLowerCase(),
              titleArabic: arabicTitle.toLowerCase(),
              bodyEnglish: body.toLowerCase(),
