...
import 'package:demo_app/features/roles/domain/enums/messages/messages_permissions_sections.dart';
import 'package:demo_app/features/roles/domain/enums/qiyas/qiyas_permissions_sections.dart';
import 'package:demo_app/features/roles/domain/interfaces/module_permissions_sections_permissions.dart';

import 'package:demo_app/core/network/get_base_url.dart';
import '../../domain/enums/form/form_permissions_sections.dart';
import '../../domain/enums/inventory/inventory_permissions_sections.dart';
import '../../domain/enums/role_status.dart';
import '../../domain/enums/services/services_permissions_sections.dart';
...
class RoleHistoryModel {
  ...
  RoleHistoryModel copyWith({
    ...
    // //print("Edited fields:");
    if (roleName != null) // //print("  - roleName: '$roleName'");
    if (roleNameAr != null) ////print("  - roleNameAr: '$roleNameAr'");
    if (roleDescription != null)// //print("  - roleDescription");
    if (roleDescriptionAr != null)// //print("  - roleDescriptionAr");
    if (roleImage != null) ////print("  - roleImage");
    if (selectedModules != null) ////print("  - selectedModules: $selectedModules");
    if (status != null) ////print("  - status: $status");
    if (editBy != null) print("  - editBy");
