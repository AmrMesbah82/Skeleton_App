...
extension RoleSwitchesControllers on RoleCubit {
  ...
  ///
  /// Parameters:
  ///             moduleName[String]: The module name (e.g., 'services', 'form_builder')
  ...
  void togglePermissionState({
    ...
    if (!selectedModules.contains(moduleName)) {
      print('Warning: Module $moduleName is not selected');
      return;
    }
    ...
    print('Updated permission $permissionKey for module $moduleName: $value');
  ...
  void toggleModuleAdminAccess({
    ...
    print('Set admin access for module $moduleName: $isAdmin');
    emit(RolePermissionUpdated());
  }
  ...
  void updateModulePermissions(String moduleName, Map<String, bool> permissions) {
    ...
    print('Updated ${permissions.length} permissions for module $moduleName');
  ...
  Future<void> saveAllPermissionsToDatabase() async {
    if (selectedRole == null) {
      print('Warning: No role selected, cannot save permissions');
      return;
    }
    ...
    for (String moduleName in selectedModules) {
      if (modulePermissions.containsKey(moduleName)) {
        try {
          ...
          print('Saved permissions for module: $moduleName');
        } catch (e) {
          print('Error saving permissions for module $moduleName: $e');
        }
      }
    }
  ...
  Future<void> loadAllPermissionsFromDatabase() async {
    if (selectedRole == null) {
      print('Warning: No role selected, cannot load permissions');
      return;
    }
      ...
      try {
        ...
        if (result.isRight()) {
          ...
          if (permissions != null) {
            ...
            print('Loaded ${modulePermissions[moduleName]!.length} permissions for module: $moduleName');
          }
        }
      } catch (e) {
        print('Error loading permissions for module $moduleName: $e');
  ...
  void resetAllPermissions() {
    ...
    print('Reset permissions for ${selectedModules.length} modules');
    emit(RolePermissionUpdated());
  }
      ...
      try {
        ...
        if (result.isRight()) {
          ...
          if (permissions != null) {
            ...
            print('Cloned permissions for module $moduleName from role ${sourceRole.currentRoleName}');
          }
        }
      } catch (e) {
        print('Error cloning permissions for module $moduleName: $e');
      }
    }
    ...
    // ✅ ADDED: Notification Module
      case 'notification':
        return {
          ...
          'Show_Form_Builder_Notifications': false,
