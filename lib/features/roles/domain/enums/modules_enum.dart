...
import 'package:demo_app/features/services_mangment_module/responsive_services.dart';
import 'package:demo_app/features/roles/domain/enums/services/services_permissions_sections.dart';
...
import '../../../database_builder/database_responsive_page.dart';


import '../../../inventory_module/inventory_responsive_page.dart';
import '../../../knowledge_hub_module/knowledge_hub_responsive_page.dart';
...
import '../../../todo_new_module/todo_responsive_page.dart';
...
import '../../../home/nav_bar/presentation/ui/pages/more_page.dart';
...
enum Modules {
  ...
  Widget get widget {
    switch (this) {
      ...
      case Modules.inventory:
        return InventoryResponsivePage();
      case Modules.grc:
      ...
      case Modules.todo:
        return TodoPageResponsive();
      case Modules.database:
        return DataBaseIntroPage();
      case Modules.messages:
      ...
      case Modules.qiyas:
        if (grcNavKey == null) {
          grcNavKey = GlobalKey();
          print('🔑 Created NEW grcNavKey: ${grcNavKey.hashCode}');
        } else {
          print('♻️ Reusing existing grcNavKey: ${grcNavKey.hashCode}');
        }
