import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_attachments.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_checklists.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_creator.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_description.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_image.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_members.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_name.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_priority.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_progress.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_progress_color.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/card_status.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/comment.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/end_date.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/end_time.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/last_update.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/start_date.dart';
import 'package:demo_app/features/external/task_management_module/task/data/model/card_model/start_time.dart';
