...
import 'package:demo_app/features/external/todo_module/features/todo_list/presentation/ui/widgets/items_list_view.dart';
...
import 'package:demo_app/features/external/todo_module/features/todo_list/presentation/ui/widgets/upper_information_chips.dart';
...
class TodoHomeContainerTablet extends StatelessWidget {
  const TodoHomeContainerTablet({super.key, required this.todoModel});
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            UpperInformationChips(
                todoModel: todoModel,
                doneItems: doneItems), // Show space if there is no chips at all
            ((todoModel.frequencyText!.frequencyText!.last == null) &&
                    ...
                    todoModel.comments?.isEmpty == true)
                ? SizedBox(height: 0)
                : SizedBox(height: 10),
              ...
              Row(
                children: [
                  ...
                  if (todoModel.endTime!.time!.last != AppConstants.empty)
                    TodoItemChipContainer(
                      title: Get.locale.toString().contains('en')
                          ? capitalizeAmPm(todoModel.endTime!.time!.last ?? "")
