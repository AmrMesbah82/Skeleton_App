...
import 'package:demo_app/features/external/todo_module/core/components/other_components/custom_black_button.dart';
...
import 'package:demo_app/features/external/todo_module/core/constants/capitalization_functions.dart';
import 'package:demo_app/features/external/todo_module/core/constants/date_time_in_arabic.dart';
import 'package:demo_app/features/external/todo_module/core/constants/enum.dart';
import 'package:demo_app/features/external/todo_module/core/helper/date_helper.dart';
...
import 'package:demo_app/features/external/todo_module/features/todo_list/presentation/ui/widgets/cancel_add_item_row.dart';
import 'package:demo_app/features/external/todo_module/features/todo_list/presentation/ui/widgets/edit_delete_icons_row.dart';
import 'package:demo_app/features/external/todo_module/features/todo_list/presentation/ui/widgets/todo_comment_title.dart';
import 'package:demo_app/features/external/todo_module/features/todo_list/presentation/ui/widgets/todo_item_chip_container.dart';
import 'package:demo_app/features/external/todo_module/features/todo_list/presentation/ui/widgets/todo_item_name_and_icon.dart';
...
/// Description:       This is a tablet screen that displays the details of a todo item.
///                    It shows the todo name, description, date, time, and comments.
///                    It also allows the user to edit or delete the todo item.
///                    This screen is used in the TodoItemTablet widget.
///
...
class TodoDetailsScreenTablet extends StatefulWidget {
  final TodoModel todoModel;

  const TodoDetailsScreenTablet({super.key, required this.todoModel});

  @override
  State<TodoDetailsScreenTablet> createState() =>
      _TodoDetailsScreenTabletState();
}

class _TodoDetailsScreenTabletState extends State<TodoDetailsScreenTablet> {
                              ...
                              child: Column(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Spacer(),
                                        // End Date & Time
                                        if (widget.todoModel.endDate?.date
                                                    ?.last !=
                                                AppConstants.empty &&
                                            widget.todoModel.status!.status !=
                                                TodoStatus.deleted)
                                  ...
                                  if (widget.todoModel.startDate!.date!.last !=
                                          ...
                                          widget.todoModel.status!.status !=
                                              TodoStatus.deleted ||
                                      widget.todoModel.comments?.isNotEmpty ==
                                              true &&
                                          widget.todoModel.status!.status !=
                                              TodoStatus.deleted)
                                  ...
                                  Row(
                                    children: [
                                      // Show Scheduled chip
                                      if (widget.todoModel.startDate!.date!
                                                  .last !=
                                              'empty' &&
                                          widget.todoModel.startTime!.time!
                                                  .last !=
                                              AppConstants.empty &&
                                          widget.todoModel.status!.status !=
                                              TodoStatus.deleted)
                                      ...
                                      // Show frequency chip
                                      if (widget.todoModel.frequencyText !=
                                              null &&
                                          widget.todoModel.frequencyText!
                                                  .frequencyText!.last !=
                                              null &&
                                          widget.todoModel.status!.status !=
                                              TodoStatus.deleted)
                                  ...
                                  SizedBox(height: 10),
                                  // Todo Description
                                  if (widget.todoModel.description?.description
                                          ?.last !=
                                      AppConstants.empty)
                                    Padding(
                                  ...
                                  ListView.separated(
                                    ...
                                    itemCount:
                                        widget.todoModel.comments?.length ?? 0,
                                    itemBuilder:
                            ...
                            Align(
                              ...
                              child: CustomIconButton(
                                ...
                                onPressed: () {
                                  ...
                                  controller.recoverTodo(
                                      widget.todoModel, context);
                                },
                              ),
                            ),
