...
class Validator {
  ...
  //todo
  String? work(String? value, String invalid) {
    String pattern =
  ...
  String? isDateValid(String dateString) {
    try {
  ...
  ///validator link
  String? isCorrectWebsiteLink(String websiteName, String link) {
    if (link == "") {
      return null;
    }
  ...
  String? text(String? value, String invalid) {
  ...
  String? insurancePolicyNumber(String? value, String invalidMessage) {
  ...
  String? maritalStatus(String? value) {
  ...
  String? validateWorkDays(String? value) {
    String pattern =
