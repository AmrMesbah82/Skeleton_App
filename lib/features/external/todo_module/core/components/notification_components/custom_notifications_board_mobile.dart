...
class CusomNotificationsBoardMobile extends StatefulWidget {
  const CusomNotificationsBoardMobile({super.key, required this.time});
  final String time;

  @override
  State<CusomNotificationsBoardMobile> createState() =>
      _CusomNotificationsBoardMobileState();
}

class _CusomNotificationsBoardMobileState
    extends State<CusomNotificationsBoardMobile> {
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Transform.scale(
                            scale: isPortrait ? 1.5 : 1.2,
                            child: SvgPicture.asset(
                                "assets/images/notify_board_mobile.svg")),
                      ),
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    "Merna Nagy invited you to Basic Education Board.",
                                    maxLines: 2,
