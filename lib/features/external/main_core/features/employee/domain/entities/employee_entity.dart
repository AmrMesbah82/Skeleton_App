...
import 'academic_historemployee_entity.dart';
import 'mobile_phone_entity.dart' show MobilePhoneEntity;
...
class EmployeeEntityController {
  ...
  static MobilePhoneEntity? _extractMobilePhone(List<MobilePhone> mobilePhoneList) {
    if (mobilePhoneList.isEmpty) return null;

    MobilePhone lastPhone = mobilePhoneList.last;
    return MobilePhoneEntity(
      phone: lastPhone.phones?.toString(),
  ...
  EmployeeEntityPro fromModel(NewEmployeeModel model) {
    return EmployeeEntityPro(
      ...
      mobilePhone: MobilePhoneEntity(
          phone: model.mobilePhone?.phones?.lastOrNull,
...
class EmployeeEntityPro {
  ...
  final String? email;
  final MobilePhoneEntity? mobilePhone;
