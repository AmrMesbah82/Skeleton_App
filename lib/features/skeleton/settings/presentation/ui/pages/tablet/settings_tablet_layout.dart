...
import '../../../../../../../feature/settings_screen/views/settings_appbar.dart';
import '../../../../../../../feature/settings_screen/views/subscribtion_screens/subscribtion_new.dart';
...
import '../../../../../employee_branding/presentation/ui/employee_branding_screen.dart';
import '../../../../../home/presentation/ui/pages/edit_home_page.dart';
import '../../../../../roles/domain/enums/modules_enum.dart';
import '../../../../../roles/domain/enums/settings/settings_permissions.dart';
import '../../../../../roles/domain/enums/settings/settings_permissions_sections.dart';
...
import 'tablet_company_info_screen.dart';
import 'tablet_personal_info_screen.dart';
import 'tablet_settings_health_insurance.dart';


class SettingsTabletLayout extends StatefulWidget {
  SettingsTabletLayout({super.key});
                                          ...
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              onTap: isMobile
                                                ...
                                                _navigateToScreen(context, TabletPersonalInfoScreen(), 'Personal Information'.tr);
                                              }
                                        ...
                                        if (hasHealthInsurance)
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              selectIndex: settingsController.selectedContainerIndex,
                                              onTap: isMobile
                                                  ? () => _navigateToScreen(context, TabletSettingsHealthInsurance(), 'Health Insurance'.tr)
                                                  : null,
                                            ),
                                          ),
                                        if (hasSocialInfo)
                                          ...
                                          if (hasBrandingTheme)
                                            Container(
                                              ...
                                              child: CustomCard(
                                                ...
                                                selectIndex: settingsController.selectedContainerIndex,
                                                onTap: isMobile
                                                    ? () => _navigateToScreen(context, TabletCompanyInfoScreen(), S.of(context).brandingAndTheme)
                                                    : null,
                                              ),
                                            ),
                    ...
                    child: Column(
                      ...
                      children: [
                        if (settingsController.selectedContainerIndex == 0 && hasPersonalInfo)
                          const TabletPersonalInfoScreen(),
