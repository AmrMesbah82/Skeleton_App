...
class _EditAccessDetailsDialogState extends State<EditAccessDetailsDialog> {
  ...
  void initState() {
    ...
    print('🎬 INIT - Firebase value: $unitFromFirebase → Capitalized: $selectedTimeUnit');
  }
              ...
              customButton(
                ...
                function: () {
                  ...
                  if (expirationTimeController.text.isEmpty) {
                    print('❌ ERROR: Expiration time is empty');
                    Get.snackbar(
                      S.of(context).error,
                  ...
                  if (defaultPasswordController.text.isEmpty) {
                    print('❌ ERROR: Default password is empty');
                    Get.snackbar(
                      S.of(context).error,
                  ...
                  print('📝 OLD VALUES:');
                  print('   - expirationTime: ${widget.accountStatusEntity.expirationTimeOfPassword}');
                  print('   - expirationUnit: ${widget.accountStatusEntity.expirationTimeUnit}');
                  print('   - password: ${widget.accountStatusEntity.tempPassword}');
                  ...
                  print('📝 NEW VALUES TO SAVE:');
                  print('   - expirationTime: ${widget.accountStatusEntity.expirationTimeOfPassword}');
                  print('   - expirationUnit: ${widget.accountStatusEntity.expirationTimeUnit}');
                  print('   - password: ${widget.accountStatusEntity.tempPassword}');
                  print('🆔 Employee ID: ${widget.accountStatusEntity.employeeId}');
                  print('👤 Employee Name: ${widget.accountStatusEntity.englishName}');

                  print('🔄 Calling controller.updateAccessDetails...');
