...
class _ModulesGrantedState extends State<ModulesGranted> {
  ...
  Widget build(BuildContext context) {
    ...
    print('🎯 SIMPLE VERSION - Modules from role: $moduleStrings');
    ...
    for (String moduleName in moduleStrings) {
      try {
        ...
        print('⚠️ Could not convert: $moduleName');
      }
    }

    print('🎯 Converted to ${moduleEnums.length} module enums');
