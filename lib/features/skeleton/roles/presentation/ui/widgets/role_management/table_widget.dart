...
class RoleTableView extends StatelessWidget {
  ...
  String _getModuleName(BuildContext context, Modules module) {
    switch (module) {
      ...
      case Modules.formBuilder:  return S.of(context).form_builder;
  ...
  Modules? _getModuleEnum(String moduleName) {
    switch (moduleName.toLowerCase().trim()) {
      ...
      default:
        print('⚠️ RoleTableView: Unknown module name: $moduleName');
        return null;
    }
  }
  ...
  List<Map<String, dynamic>> _expandRolesByModules(RoleHistoryModel role) {
    ...
    ModulesController().getRoleActiveModules(role);
  ...
  int _getModulePermissionCount(String moduleString) {
    ...
    ModulesController().getDefaultPermissionsForModule(moduleString);
  ...
  String _formatPermissionName(String permissionKey) {
    return permissionKey
        ...
        : '')
        .join(' ')
        .tr; // ← .tr resolves AR/EN from GetX translations
  }
  ...
  Future<List<String>> _loadActivePermissions(
    ...
    try {
      ...
      print('Error loading active permissions: $e');
      return [];
    }
  }
                ...
                return TableRow(
                  ...
                  children: [
                    ...
                    _cell(
                      context,
                      Text(
                        role.currentStatus.name.tr.capitalize ??
