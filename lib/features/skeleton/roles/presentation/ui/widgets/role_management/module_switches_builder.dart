...
import 'package:demo_app/features/skeleton/roles/domain/enums/modules_enum.dart';
...
import '../../../../../../external/main_core/core/theme/app_text_styles.dart';
import '../../../../../../external/main_core/core/theme/app_theme.dart';
...
class _ModuleSwitchesBuilderState extends State<ModuleSwitchesBuilder> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<RoleCubit, RoleState>(
      ...
      builder: (context, state) {
        ...
        print("\n=== ModuleSwitchesBuilder (${widget.module.name}) ===");
        print("Module name: $moduleName");
        print("Has permissions: ${controller.modulePermissions.containsKey(moduleName)}");

        if (controller.modulePermissions.containsKey(moduleName)) {
          print("Permission count: ${controller.modulePermissions[moduleName]!.length}");
          print("Permissions keys: ${controller.modulePermissions[moduleName]!.keys.toList()}");
          print("📊 ACTUAL VALUES IN MAP:");
        ...
        if (!controller.modulePermissions.containsKey(moduleName) ||
          ...
          print("⚠️ No permissions - HIDING module");
  ...
  Widget modulePermissionsBuilder(Modules module) {
    ...
    print("📊 Module: $moduleName, Has Enum: $hasEnumPermissions");
  ...
  Widget buildPermissionSection<T extends ModulePermissionsSections>(
    ...
    print("\n🐛 DEBUG buildPermissionSection:");
    print("   Section getName: '$sectionName'");
    print("   Section getName type: ${sectionName.runtimeType}");
    ...
    print("🔍 Section: ${permissionSection.getName}, Found Key: $foundKey, Value: $sectionValue");
            ...
            Expanded(
              child: Builder(
                  builder: (context) {
                    ...
                    print("🐛 DEBUG Section Text Widget:");
                    print("   Raw value: '$displayText'");
                    print("   Text length: ${displayText.length}");
                    print("   First 20 chars: '${displayText.substring(0, min(20, displayText.length))}'");
            ...
            if (foundKey != null)
              DefaultSwitchButton(
                  ...
                  onChanged: (value) {
                    ...
                    print("✅ Updated section $foundKey = $value");
                  })
            else
  ...
  Widget _buildEnumPermissionRow(
    ...
    print("\n🐛 DEBUG _buildEnumPermissionRow:");
    print("   Permission getUiName: '$uiName'");
    print("   Permission getUiName type: ${uiName.runtimeType}");
    print("   Is Arabic? ${uiName.contains(RegExp(r'[\u0600-\u06FF]'))}");
    ...
    print("🔍 Permission: ${permission.getUiName}, Found Key: $foundKey, Value: $permissionValue");
        ...
        Expanded(
            child: Builder(
                builder: (context) {
                  ...
                  // 🐛 DEBUG: Print what's being displayed
                  print("🐛 DEBUG Permission Text Widget:");
                  print("   Raw value: '$displayText'");
                  print("   Text length: ${displayText.length}");
                  print("   Contains Arabic? ${displayText.contains(RegExp(r'[\u0600-\u06FF]'))}");
                  print("   First 30 chars: '${displayText.substring(0, min(30, displayText.length))}'");
        ...
        if (shouldShowSwitch)
          DefaultSwitchButton(
              ...
              onChanged: (value) {
                ...
                controller.emit(RoleSwitchToggled());
                print("✅ Updated permission $foundKey = $value");
              })
        else
          SizedBox(width: 40.sp), // Empty space for alignment
      ],
        ...
        children: [
          ...
          DefaultSwitchButton(
            ...
            onChanged: (value) {
              ...
              controller.emit(RoleSwitchToggled());
              print("✅ Updated $permissionKey = $value");
            },
          ),
        ],
      ),
