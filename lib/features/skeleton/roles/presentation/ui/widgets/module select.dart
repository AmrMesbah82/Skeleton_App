...
class _ModulePermissionsWidgetState extends State<ModulePermissionsWidget> {
  ...
  Future<void> _loadPermissions() async {
    ...
    print('🔍 Loading permissions for modules: $moduleStrings');
    ...
    if (result.isRight()) {
      ...
      for (String moduleName in moduleStrings) {
        if (allPermissions.containsKey(moduleName)) {
          ...
          print('✅ Loaded ${permissions.length} permissions for $moduleName');
        }
      }
    }
        ...
        children: [
          ...
          AnimatedSize(
            ...
            child: isExpanded && hasPermissions
              ...
              decoration: BoxDecoration(
                color: AppColorsThree.primary.withOpacity(0.3),
