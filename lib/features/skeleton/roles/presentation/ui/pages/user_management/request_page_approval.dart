...
import 'package:demo_app/features/skeleton/roles/presentation/ui/pages/user_management/user_mangement_details_request.dart';
                ...
                children: [
                  Expanded(
                    child: CustomKnowticedTextField(
                      ...
                      focusedBorderColor: AppColorsThree.primary,
                      onChanged: (val) {
                        _onSearchChanged();
                      },
                    ),
