...
import 'package:demo_app/features/skeleton/roles/presentation/ui/pages/user_management/uoload_file_details.dart';
          ...
          children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: _isDragging
                              ? (lightMode
                              ? AppColorsThree.primary.withOpacity(0.1)
                              : AppColorsThree.primary.withOpacity(0.2))
                              : (AppColors.card),
            ...
            if (selectedFileName != null) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColorsThree.primary.withOpacity(0.1),
                  borderRadius: BorderRadius.circular(8.r),
                ),
                child: Row(
                  children: [
