...
import 'package:demo_app/features/external/grc/grc_module/grc_owner/presentation/widgets/add_champion/upload_file_details_toggle.dart';
...
import '../../../../../../external/main_core/core/theme/app_colors.dart' show AppColors;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected ? AppColorsThree.secondaryPrimary : Colors.transparent,
        borderRadius: BorderRadius.circular(6.r),
        border: isSelected
            ? null
            : Border.all(
            color: borderColor ?? AppColorsThree.grey, width: 1.5.sp),
      ),
      child: Center(
                                    ...
                                    customButton(
                                        ...
                                        function: () async {
                                          ...
                                          customButton(
                                            ...
                                            textStyle: StyleText.fontSize16Weight500.copyWith(
                                              color: getTotalErrorCount() > 0 ? Colors.black  : AppColorsThree.textButton ,
                                            ),
                                            width: 150.sp,
                                            height: 38.sp,
                                            radius: 8.r,
