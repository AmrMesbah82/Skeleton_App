...
import 'package:demo_app/features/skeleton/roles/presentation/controller/modules_controller.dart';
...
// Add this at the top of your RoleCubit class
  ...
  pickRoleImage({required bool camera}) async {
    try {
      print("\n🖼️ ========================================");
      print("🖼️ pickRoleImage called");
      print("🖼️ Camera mode: $camera");

      final ImagePicker picker = ImagePicker();

      print("🖼️ Calling image picker...");
      ...
      print("🖼️ Image picker returned");
      print("🖼️ Result is null: ${result == null}");
      ...
      try {
        ...
        if (!validFormats.contains(extension)) {
          ...
          print("❌ Valid formats: $validFormats");
          print("🖼️ ========================================\n");
        ...
        if (!exists) {
          print("❌ File does not exist at path: ${result.path}");
          print("🖼️ ========================================\n");
        ...
        print("🖼️ Attempting to decode image...");
        try {
          ...
          print("   Width: ${decodedImage.width}px");
          print("   Height: ${decodedImage.height}px");
          print("   Aspect ratio: ${(decodedImage.width / decodedImage.height).toStringAsFixed(2)}");
          ...
          print("❌ Decode error type: ${decodeError.runtimeType}");
          print("❌ Stack trace:");
          print(decodeStack);
          print("🖼️ ========================================\n");
        ...
        if (bytes.length > 10 * 1024 * 1024) {
          print("⚠️ Warning: Image is larger than 10MB");
          print("   Consider compressing it for better performance");
        ...
        roleImage = file;
        print("✅ Role image updated successfully");
        print("   roleImage path: ${roleImage?.path}");
        print("🖼️ ========================================\n");

        emit(RoleImagePicked());

      } catch (readError, readStack) {
        print("❌ Error reading image bytes:");
      ...
      print("❌ ========================================");
      print("❌ EXCEPTION in pickRoleImage:");
      print("❌ Error: $e");
