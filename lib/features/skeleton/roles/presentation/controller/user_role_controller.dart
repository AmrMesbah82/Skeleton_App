...
import 'package:demo_app/features/skeleton/roles/domain/use_cases/update_selected_members_use_case.dart';
...
import '../../domain/use_cases/delete_user_permission_use_case.dart';
import '../../domain/use_cases/update_user_permission_use_case.dart';
import '../../utils/constants.dart';
import '../../utils/role_update_ids.dart';
...
class EmployeeRoleController extends GetxController {
  ...
  getUsersPermissionsData() async {
    print("getUsersPermissionsData entered");
    ...
    print("getUsersPermissionsData finished");
  ...
  updateUserPermission({
    ...
    if (permission == null) {
      print('Error: Permission not found for employee $employeeId');
      return;
    }
