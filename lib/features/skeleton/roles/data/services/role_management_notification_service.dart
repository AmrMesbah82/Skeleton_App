...
class RoleManagementNotificationService {
  ...
  static Future<void> _sendPushNotification({
    ...
    try {
      print("📤 Push → $recipientEmail | $title");
  ...
  static Future<void> _saveNotificationToFirestore({
    ...
    try {
      ...
      print("✅ Notification saved → $receiverEmail");
    } catch (e) {
  ...
  static Future<void> sendAccountActivatedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Account Activated [Role Management]");
    print("🔔 ════════════════════════════════════════");
  ...
  static Future<void> sendAccountDeactivatedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Account Deactivated [Role Management]");
    print("🔔 ════════════════════════════════════════");
  ...
  static Future<void> sendActivationScheduledNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Activation Scheduled [Role Management]");
    print("🔔 ════════════════════════════════════════");
  ...
  static Future<void> sendDeactivationScheduledNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Deactivation Scheduled [Role Management]");
    print("🔔 ════════════════════════════════════════");
  ...
  static Future<void> sendAccessScheduleUpdatedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Access Schedule Updated [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Access Schedule Updated notification sent");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendScheduledActionCancelledNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Scheduled Action Cancelled [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Scheduled Action Cancelled notification sent");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendAccountUnlockedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Account Unlocked [Role Management]");
    print("🔔 ════════════════════════════════════════");
  ...
  static Future<void> sendAccountLockedFailedAttemptsNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Account Locked - Failed Attempts [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Account Locked (Failed Attempts) notification sent to admins");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendAccessGrantedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Access Granted [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Access Granted notification sent");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendAccessUpdatedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Access Updated [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Access Updated notification sent");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendAccessRevokedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Access Revoked [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Access Revoked notifications sent");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendAccessChangeScheduledNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Access Change Scheduled [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Access Change Scheduled notification sent");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendScheduledAccessAppliedNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Scheduled Access Applied [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Scheduled Access Applied notifications sent");
    print("🔔 ════════════════════════════════════════\n");
  }
  ...
  static Future<void> sendScheduledAccessCancelledNotification({
    ...
    print("\n🔔 ════════════════════════════════════════");
    print("🔔 SENDING: Scheduled Access Cancelled [Role Management]");
    print("🔔 ════════════════════════════════════════");
    ...
    print("✅ Scheduled Access Cancelled notification sent");
    print("🔔 ════════════════════════════════════════\n");
  }
}
