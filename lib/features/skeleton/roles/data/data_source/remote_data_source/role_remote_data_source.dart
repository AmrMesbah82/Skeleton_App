...
class RoleRemoteDataSource {
  ...
  updateRole(
    ...
    print("role data is ${ApiConstants.roles} and id is ${roleID}");
    Either<FirebaseFailure, dynamic> result =
  ...
  Future<Either<Failure, dynamic>> commitTransaction() async {
    try {
      print("════════════════════════════════════════════════════════");
      print("🔄 [REMOTE] Committing batch transaction...");
      await _batch.commit();
      print("✅ [REMOTE] Transaction committed successfully");
      print("════════════════════════════════════════════════════════");
      return Right(true);
    } catch (e, stackTrace) {
      print("════════════════════════════════════════════════════════");
      print("❌❌❌ [REMOTE] Transaction commit FAILED");
      print("Error: $e");
      print("Stack trace:\n$stackTrace");
      print("════════════════════════════════════════════════════════");
      return Left(FeatureFailure(e.toString()));
  ...
  void updateRoleWithinTransaction(
    ...
    print(
        "User Management update path is Demo/$companyId/${USER_MANAGEMENT_COLLECTION}/$id");
  ...
  void updateEmployeeModel(
      {required String id, required Map<String, dynamic> data}) {
    print(
        "Employees_Info update path is Demo/$companyId/${EMPLOYEES_INFO_COLLECTION}/$id");
