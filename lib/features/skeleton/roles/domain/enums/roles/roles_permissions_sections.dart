...
import 'package:demo_app/features/skeleton/roles/domain/enums/roles/role_mangment_permission.dart';
import 'package:demo_app/features/skeleton/roles/domain/enums/roles/user_access_permission.dart';
import 'package:demo_app/features/skeleton/roles/domain/enums/roles/user_mangment_permission.dart';
...
enum RolePermissionsSections implements ModulePermissionsSections, ModulePermissionsSectionsPermission {
  ...
  String get getName {
    switch (this) {
      case RolePermissionsSections.roleManagement:
        return AppConstanstForm.roleManagement.tr;
      case RolePermissionsSections.userAccess:
        return AppConstanstForm.userAccess.tr;
      case RolePermissionsSections.userManagement:
        return AppConstanstForm.userManagement.tr;
      case RolePermissionsSections.activeDirectory:
        return AppConstanstForm.activeDirectory.tr;
    }
  }
  ...
  String get getUiName {
    switch (this) {
      case RolePermissionsSections.roleManagement:
        return AppConstanstForm.roleManagementModule.tr;
      case RolePermissionsSections.userAccess:
        return AppConstanstForm.userAccessModule.tr;
      case RolePermissionsSections.userManagement:
        return AppConstanstForm.userManagementModule.tr;
      case RolePermissionsSections.activeDirectory:
        return AppConstanstForm.activeDirectoryModule.tr;
    }
  }
