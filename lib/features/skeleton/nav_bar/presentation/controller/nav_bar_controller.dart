...
import 'package:demo_app/features/skeleton/nav_bar/utils/nav_bar_constant_modules.dart';
...
import '../../../roles/presentation/controller/modules_controller.dart';
...
class NavBarController extends GetxController {
  ...
  // ✅ ADD: Company license data (same as AppDrawerController)
  ...
  // ✅ ADD: Extract company ID (same as AppDrawerController)
  ...
  // ✅ ADD: Load company licensed modules from Firebase (same as AppDrawerController)
  ...
  // ✅ ADD: Check if module is licensed (same as AppDrawerController)
  ...
  void _getNavBarModules() {
    ...
    print('🔧 NavBar: Mode.owner: ${Mode.owner}, Mode.hr: ${Mode.hr}');
