...
class SystemLogsModel {
  ...
  SystemLogsModel.fromMap(dynamic json) {
    userEmail = capitalize(json[USER_EMAIL]);
    firstName = capitalize(json[FIRST_NAME]);
    middleName = capitalize(json[MIDDLE_NAME]);
    lastName = capitalize(json[LAST_NAME]);
    firstNameInArabic = json[FIRST_NAME_ARABIC];
    middleNameInArabic = json[MIDDLE_NAME_ARABIC];
    lastNameInArabic = json[LAST_NAME_ARABIC];
    country = capitalize(json[COUNTRY]);
    city = capitalize(json[CITY]);
    role = capitalize(json[ROLE]);
    lat = json[LAT];
    long = json[LONG];
    action = capitalize(json[ACTION]);
