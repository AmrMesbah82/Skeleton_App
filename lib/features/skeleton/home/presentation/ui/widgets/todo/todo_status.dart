...
import 'package:demo_app/features/external/services_mangment_module/Category/presentation/ui/service_employee/Widget/W2_Navigator.dart';

import '../../../../../../../generated/l10n.dart';
import '../../../../../../external/main_core/core/theme/app_colors.dart';
import '../../../../../../external/main_core/core/theme/app_text_styles.dart';
import '../../../../../../external/todo_new_module/external/tasks_module/category/data/models/task_model_updates_with_field_history.dart';
import '../../../../../../external/todo_new_module/external/tasks_module/category/domain/services/task_services.dart';
import '../../../../../../external/todo_new_module/external/tasks_module/category/presentation/screens/to_do_list/home_screen.dart';
import '../../../../../../external/todo_new_module/external/tasks_module/core/enums/task_priority_enum.dart';
import '../../../../../../external/todo_new_module/external/tasks_module/core/enums/task_status_enum.dart';
                ...
                Column(
                  ...
                  children: [
                    item(
                      color: AppColors.red,
                      number: '${stats['high']}',
                      icon: 'assets/home_module/hight.svg',
                    ),
                    item(
                      color: AppColors.yellow,
                      number: '${stats['medium']}',
                      icon: 'assets/home_module/mudium.svg',
                    ),
                    item(
                      color: AppColors.green,
                      number: '${stats['low']}',
                      icon: 'assets/home_module/low.svg',
                    ),
                  ],
                ),
                const SizedBox.shrink(),
