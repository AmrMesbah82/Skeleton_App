...
import 'package:demo_app/core/helper/employees/data/models/department_model/department_model.dart' as newDepartmentModel;
...
class EmployeeController extends GetxController with StateMixin {
  ...
  List<ValueItem<dynamic>> selectedDaysOptions = [];

  void selecteItem(List<ValueItem<dynamic>> item) {
