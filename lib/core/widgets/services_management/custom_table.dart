              ...
              return MouseRegion(
                ...
                child: Material(
                  color: useAlternatingRowColors
                      ...
                      : (rowOddColor ?? (isLight ? Colors.white : const Color(0xFF1E1E1E))))
                      : Colors.transparent,
                  child: InkWell(
...
class ServicesTableWidget extends StatelessWidget {
  ...
  TextStyle get _headerStyle => AppTextStyles.font15BlackCairoRegular.copyWith(color: Colors.white);
  ...
  Color _getStatusColor(String status) {
    switch (status.toLowerCase()) {
      ...
      case 'cancel':
      case 'ملغي':
        return Colors.red[900]!; // Dark Red
      case 'inprogress':
      case 'in progress':
      case 'قيد التنفيذ':
