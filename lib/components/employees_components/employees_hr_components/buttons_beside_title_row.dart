...
import 'package:demo_app/components/employees_components/employees_hr_components/employees_hr_subwidgets/custom_container_photo.dart';
        ...
        Padding(
            ...
            child: GestureDetector(
              ...
              child: CustomPhotoContainer(
                  ...
                  backColor: AppColorsThree.primary,
                  borderColor: Colors.transparent,

                  photoColor: widget.orgSelected
                      ? AppColorsThree.textButton
                      : Theme.of(context).colorScheme.scrim),
            )),
      ],
    );
