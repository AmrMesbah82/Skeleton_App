...
import 'package:demo_app/components/employees_components/employees_hr_components/employee_hr_profile_components/custom_personal_Info_Container.dart';
import 'package:demo_app/core/enumeration/enum.dart';
import 'package:demo_app/core/theme/screen_size.dart';
import 'package:demo_app/features/skeleton/controllers/users_access_controller.dart';
...
import 'package:demo_app/features/skeleton/roles/presentation/controller/role_controller.dart';

import '../../features/external/main_core/features/employee/data/models/emplyees_model/mobile_phone_model.dart';
import '../../features/external/main_core/features/employee/data/models/emplyees_model/new_employee_model.dart';
...
import '../../features/skeleton/roles/domain/enums/settings/settings_permissions_sections.dart';
import '../../features/skeleton/roles/domain/enums/settings/social_permissions.dart';
...
class _EmployeeWorkInfoScreenEmployeeViewMobileState
  ...
  RoleController addRoleController = Get.find();
  RoleModel? accessTypeEmployee;
  ...
  Future<void> getAccessTypeByName() async {
    ...
    if (email.isNotEmpty) {
      await usersAccessController.getUserAcess(email);
    }
    setState(() {});
  }
  ...
  String _getDepartmentName() {
    ...
    if (Get.locale.toString().contains('en')) {
      return Get.find<AddDepartmentController>()
        ...
        children: [
          ...
          CustomPersonalInfoContainer(
            ...
            customIcons: hasSupervisor
                ? [
              'assets/employee_assets/new_department.svg',
              'assets/employee_assets/new_superVisor.svg',
          ...
          CustomPersonalInfoContainer(
            ...
            customIcons: [
              'assets/employee_assets/new_start_date.svg',
              'assets/employee_assets/new_work_hourse.svg',
              'assets/employee_assets/new_day_off.svg',
           //   'assets/employee_assets/new_sallary.svg',
              'assets/employee_assets/new_job_location.svg',
            ],
            personalInfoTexts: [
          ...
          CustomPersonalInfoContainer(
            ...
            customIcons: [
              if(Get.find<MainCoreEmployeeController>().isHasPermission(
                ...
                'assets/employee_assets/new_institution_name.svg',
              if(Get.find<MainCoreEmployeeController>().isHasPermission(
                module: Modules.settings,
                section: SettingsPermissionsSections.socialPermissions,
                permission: SocialPermissions.certificates,
              ))
                'assets/employee_assets/new_degree.svg',
              if(Get.find<MainCoreEmployeeController>().isHasPermission(
                module: Modules.settings,
                section: SettingsPermissionsSections.socialPermissions,
                permission: SocialPermissions.certificates,
              ...
              if(Get.find<MainCoreEmployeeController>().isHasPermission(
                ...
                'assets/skills_new.svg',
              if(Get.find<MainCoreEmployeeController>().isHasPermission(
                module: Modules.settings,
                section: SettingsPermissionsSections.socialPermissions,
                permission: SocialPermissions.skillsHobbies,
              ))
                'assets/hobbies_new.svg',
            ],
            personalInfoTexts: [
              if(Get.find<MainCoreEmployeeController>().isHasPermission(
                module: Modules.settings,
